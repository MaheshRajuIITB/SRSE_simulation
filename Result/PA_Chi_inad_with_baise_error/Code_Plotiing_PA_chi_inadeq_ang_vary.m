...
% load("res_20250310_PA_Chi_inadequate_weights_ang_vary_IEEE_30.mat")
% load("PA_Chi_inadequate_weights_0.1to2_no_baise_error.mat")
% load("PA_Chi_inadequate_weights_1to2_no_baise_error.mat")
% load("PA_Chi_inadequate_weights_0.1to0.9_no_baise_error.mat")
% load("PA_Chi_inadequate_weights_0.1to2_with_baise_error.mat")
% load("PA_Chi_inadequate_weights_baise_error_in_2PMUs.mat")
% load("PA_Chi_inadequate_weights_baise_error_in_1PMU.mat")
% load("PA_Chi_inadequate_weights_baise_error_in_1PMU_2.mat")

% load("PA_Chi_inadequate_weights_0.1to2_no_baise_error.mat")
% load("PA_Chi_inadequate_weights_baise_error_in_1PMU_with_positive_angle.mat")
% load("PA_Chi_inadequate_weights_baise_error_in_1PMU_with_negative_angle.mat")

% load("PA_Chi_inadequate_weights_baise_error_in_1PMU_with_positive_angle_2.mat")
% load("PA_Chi_inadequate_weights_baise_error_in_1PMU_with_negative_angle_2.mat")

% load("PA_Chi_inadequate_weights_baise_error_in_3PMUs.mat")
load("PA_Chi_inadequate_weights_baise_error_in_3PMUs_ang_var_0to10.mat")


% spf_ang_variation = 0:0.1:1;
spf_ang_variation = 1:1:11;
...
yyaxis left;
h2 = boxplot(Chi_with_inadequate_weights(:,1:11), 'Positions', spf_ang_variation - 0.15, 'Widths', 0.3, 'Colors', 'b');
...
yyaxis right;
boxplot(PA_with_inadequate_weights(:,1:11), 'Positions', spf_ang_variation + 0.15, 'Widths', 0.3, 'Colors', 'r'); 
