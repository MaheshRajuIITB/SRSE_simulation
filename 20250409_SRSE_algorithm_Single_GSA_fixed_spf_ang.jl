...
LSE_PA_monte = zeros(Float32, monte_simulation, No_of_PMUs)
...
NLS_PA_monte = zeros(Float32, monte_simulation, No_of_PMUs)
...
for Position_Spoofed_PMUs in Np
    ...
    for monte in 1:monte_simulation
        ...
        LSE_PA_monte[monte, Position_Spoofed_PMUs] = Principal_angle
        ...
        if Principal_angle > PA_threshold
            ...
            NLS_PA_monte[monte, Position_Spoofed_PMUs] = NLS_PA
        else
            NLS_PA_monte[monte, Position_Spoofed_PMUs] = Principal_angle
        end
